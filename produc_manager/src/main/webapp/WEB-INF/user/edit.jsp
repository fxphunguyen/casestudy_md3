                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="name" class="form-control"
                                           value="${requestScope["user"].username}" placeholder="${requestScope["user"].username}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="phone" class="form-control"
                                           value="${requestScope["user"].phone}" placeholder="${requestScope["user"].phone}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="email" id="example-email" name="email"
                                           value="${requestScope["user"].email}" class="form-control"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    placeholder="${requestScope["user"].password}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="row">
                                    <div style="display: none">
                                        <input type="text"  name="img" value="${requestScope["user"].imageUrl}"
                                        placeholder="${requestScope["user"].imageUrl}">${requestScope["user"].imageUrl}
                                    </div>
                                    <div>
                                        <img src="${requestScope["user"].imageUrl}" style="width: 200px; height: 200px;">
                                    </div>
                                    <div>
                                        <input type="file" name="image" class="form-control"
                                               value="${requestScope["user"].imageUrl}">
                                    </div>
                                </div>
                            </div>
